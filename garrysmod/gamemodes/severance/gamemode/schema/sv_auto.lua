...
for k, v in pairs( _file.Find("materials/models/humans/female/group01/apocal*.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/apocal*.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/bloocobalt/clothes/*.*", true) ) do
...
for k, v in pairs( _file.Find("materials/models/weapons/ashotgunskin1/*.*", true) ) do
...
for k, v in pairs( _file.Find("materials/models/zed/male/*.*", true) ) do
...
for k, v in pairs( _file.Find("models/bloocobalt/clothes/*.*", true) ) do
...
for k, v in pairs( _file.Find("sound/runner/*.*", true) ) do
	resource.AddFile("sound/runner/"..v);
end;

for k, v in pairs( _file.Find("models/zed/*.*", true) ) do

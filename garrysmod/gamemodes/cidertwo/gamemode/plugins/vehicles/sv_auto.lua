...
for k, v in pairs( _file.Find("materials/models/props_vehicles/car002a_01.*", true) ) do
	resource.AddFile("materials/models/props_vehicles/"..v);
end;

for k, v in pairs( _file.Find("materials/models/props/de_tides/truck001c_01.*", true) ) do
	resource.AddFile("materials/models/props/de_tides/"..v);
end;

for k, v in pairs( _file.Find("materials/models/props/de_tides/trucktires.*", true) ) do
	resource.AddFile("materials/models/props/de_tides/"..v);
end;

for k, v in pairs( _file.Find("materials/models/ill_hanger/vehicles/*.*", true) ) do
	resource.AddFile("materials/models/ill_hanger/vehicles/"..v);
end;

for k, v in pairs( _file.Find("materials/models/copcar/*.*", true) ) do
	resource.AddFile("materials/models/copcar/"..v);
end;

for k, v in pairs( _file.Find("sound/vehicles/truck/*.*", true) ) do
	resource.AddFile("sound/vehicles/truck/"..v);
end;

for k, v in pairs( _file.Find("sound/vehicles/enzo/*.*", true) ) do
	resource.AddFile("sound/vehicles/enzo/"..v);
end;

for k, v in pairs( _file.Find("sound/vehicles/cf_mech*.*", true) ) do
	resource.AddFile("sound/vehicles/"..v);
end;

for k, v in pairs( _file.Find("sound/vehicles/digger_*.*", true) ) do
	resource.AddFile("sound/vehicles/"..v);
end;

for k, v in pairs( _file.Find("models/tideslkw.*", true) ) do
	resource.AddFile("models/"..v);
end;

for k, v in pairs( _file.Find("materials/corvette/*.*", true) ) do
	resource.AddFile("materials/corvette/"..v);
end;

for k, v in pairs( _file.Find("materials/golf/*.*", true) ) do
	resource.AddFile("materials/golf/"..v);
end;

for k, v in pairs( _file.Find("models/corvette/*.*", true) ) do
	resource.AddFile("models/corvette/"..v);
end;

for k, v in pairs( _file.Find("models/golf/*.*", true) ) do
	resource.AddFile("models/golf/"..v);
end;

for k, v in pairs( _file.Find("models/copcar.*", true) ) do
	resource.AddFile("models/"..v);
end;

for k, v in pairs( _file.Find("models/trabbi.*", true) ) do
	resource.AddFile("models/"..v);
end;

for k, v in pairs( _file.Find("scripts/vehicles/*.*", true) ) do

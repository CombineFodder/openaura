...
resource.AddFile("materials/cidertwo/gradient2.vtf");
resource.AddFile("materials/cidertwo/gradient2.vmt");
...
for k, v in pairs( _file.Find("materials/models/humans/female/group01/cikizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/cikizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/female/group01/cirizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/cirizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/female/group01/ciaizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/ciaizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/female/group01/cilizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/cilizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/female/group01/cibizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/cibizen_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/female/group01/cityadm_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;
...
for k, v in pairs( _file.Find("materials/models/humans/female/group01/freerun_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/female/group01/"..v);
end;

for k, v in pairs( _file.Find("materials/models/humans/male/group01/freerun_sheet.*", true) ) do
	resource.AddFile("materials/models/humans/male/group01/"..v);
end;
...
for k, v in pairs( _file.Find("materials/katharsmodels/contraband/*.*", true) ) do
	resource.AddFile("materials/katharsmodels/contraband/"..v);
end;

for k, v in pairs( _file.Find("materials/katharsmodels/syringe_out/*.*", true) ) do
	resource.AddFile("materials/katharsmodels/syringe_out/"..v);
end;

for k, v in pairs( _file.Find("materials/katharsmodels/syringe_in/*.*", true) ) do
	resource.AddFile("materials/katharsmodels/syringe_in/"..v);
end;

for k, v in pairs( _file.Find("materials/jaanus/ecstac_a.*", true) ) do
	resource.AddFile("materials/jaanus/"..v);
end;

for k, v in pairs( _file.Find("materials/jaanus/morphi_a.*", true) ) do
	resource.AddFile("materials/jaanus/"..v);
end;

for k, v in pairs( _file.Find("materials/models/drug/*.*", true) ) do
